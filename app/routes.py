...
def ask():
    try:
        ...
        # 시스템 메시지 설정
        system_messages = {
            "professional": "당신은 전문가입니다. 명확하고 정확하게 답변하세요. 전문 용어를 적절히 사용하되 이해하기 쉽게 설명하세요.",
            "friendly": "당신은 친근한 대화 상대입니다. 편안하고 친근한 어조로 대화하세요. 이모티콘을 적절히 사용해도 좋습니다.",
            "creative": "당신은 창의적인 사고가 가능한 AI입니다. 새롭고 독창적인 관점에서 답변하세요. 다양한 시각과 아이디어를 제시하세요.",
        }

        # 응답 길이 설정
        max_tokens = {"short": 150, "medium": 300, "long": 600}
